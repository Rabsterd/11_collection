...
public class StudentService {
	...
	public StudentService() {
		...
		studentList.add(new Student("오미나", 21, "충북 청주시", 'F', 60));
		studentList.add(new Student("박주희", 26, "서울시 서대문구", 'F', 70));
	}
	...
	public void selectAll() {
		...
		for(Student std : studentList) {
			// std에는 for문 반복 시 마다 0,1,2.. 인덱스 요소들 한번씩 저장된 
	...
	public String removeStudent() throws InputMismatchException{
		...
		if(studentList.isEmpty()) {
			...
			char ch = sc.next().toUpperCase().charAt(0); //소문자로 써도 대문자로
